...
def game_loop_manual(environment: tuple[tuple[int,int]], start: tuple[int,int], walls: list[tuple(int,int)], object_coloring: map, color_for_background, actions_to_do: list[tuple[int,int]], possible_actions: list[tuple[int,int]],rendering: str, cell_value_to_name_map: dict, q_table: tuple[tuple[float]], run_number: int, coords_of_run_action_numbers: tuple[int,int]) -> list[bool]:
    ...
    from rendering_file import display_run_and_action_number
    ...
    for action in actions_to_do:
        ...
        action_run_message_coords_in_pixels = coords_to_center_of_cell_in_pixels(coords_of_run_action_numbers)
        display_run_and_action_number(run_number,action_number, pixel_rendering_offset_x_from_top_left,pixel_rendering_offset_y_from_top_left, action_run_message_coords_in_pixels, Font)
...
def game_loop_learning_one_run(action_limit: int, possible_actions: list[tuple[int,int]],environment: tuple[tuple[int,int]], environment_row_count: int, environment_column_count: int, start: tuple[int,int], goals: list[tuple[int,int]], walls: list[tuple[int,int]], object_coloring: dict, color_for_background: tuple[int],q_table: tuple[tuple[int,int]], epsilon: float, alpha:float, gamma: float, rendering: str, cell_value_to_name_map: dict, cell_reward:dict, run_number:int, coords_of_run_action_numbers: tuple[int,int]) -> tuple[list[tuple[int,int]], tuple[tuple[int,int]]]:
    ...
    game_loop_manual(environment,start,walls,object_coloring, color_for_background, chosen_actions_list, possible_actions,rendering, cell_value_to_name_map,q_table, run_number,coords_of_run_action_numbers)

    return (chosen_actions_list, q_table)

def game_loop_learning_multiple_runs(runs: int, action_limit: int, possible_actions: list[tuple[int,int]],environment: tuple[tuple[int,int]], environment_row_count: int, environment_column_count: int, start: tuple[int,int], goals: list[tuple[int,int]], walls: list[tuple[int,int]], object_coloring: dict, color_for_background: tuple[int],q_table: tuple[tuple[int,int]], epsilon: float, alpha:float, gamma: float, rendering: str, cell_value_to_name_map: dict, cell_reward:dict, coords_of_run_action_numbers: tuple[int,int]):
    ...
    for i in range(0,runs):
        ...
        game_loop_learning_one_run(action_limit, possible_actions,environment, environment_row_count, environment_column_count, start,goals,walls,object_coloring,color_for_background,q_table,epsilon,alpha,gamma,rendering,cell_value_to_name_map,cell_reward, run_number, coords_of_run_action_numbers)
